# /docs:from-standard - Documentation Generator from Standards
...
```qwen
/docs:from-standard Using the template @docs/api_standard.md. The codebase is in the current directory.
```

### Generate module-specific documentation
```qwen
/docs:from-standard For the 'utils' module, following the standard @docs/module_standard.md. The code is in @src/utils/.
```

### Generate API documentation
```qwen
/docs:from-standard For REST API endpoints, using @docs/api_template.md as the standard. Analyze @src/api/
```

### Generate CLI tool documentation
```qwen
/docs:from-standard For CLI commands, following @docs/cli_standard.md. The commands are in @src/commands/
```
