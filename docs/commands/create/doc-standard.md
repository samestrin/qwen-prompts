# /create:doc-standard - Documentation Standard Creator
...
```qwen
/create:doc-standard For a public-facing REST API documentation
```

### Create standard from existing files
```qwen
/create:doc-standard For our Python CLI tools, using these files as a style reference @doc1.md @doc2.md
```

### Industry-specific standard
```qwen
/create:doc-standard For enterprise software documentation with compliance requirements
```

### Open source project standard
```qwen
/create:doc-standard For open source project documentation including contribution guidelines
```
